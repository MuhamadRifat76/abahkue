...
<html lang="en">
  <head>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('/frontend/vegefoods/images/bg_1.jpg');">
      <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <p>
              <img src="/frontend/vegefoods/images/image_1.jpg" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="/frontend/vegefoods/images/image_2.jpg" alt="" class="img-fluid">
            </p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio align-self-md-center mr-4">
                <img src="/frontend/vegefoods/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="/frontend/vegefoods/images/person_1.jpg" alt="Image placeholder">
                  </div>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(/frontend/vegefoods/images/image_1.jpg);"></a>
                <div class="text">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(/frontend/vegefoods/images/image_2.jpg);"></a>
                <div class="text">
                  <h3 class="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> April 09, 2019</a></div>
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(/frontend/vegefoods/images/image_3.jpg);"></a>
                <div class="text">
                  <h3 class="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> April 09, 2019</a></div>
  ...
  <script src="/frontend/vegefoods/https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
