...
<html lang="en">
  <head>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index">Home</a></span> <span>About us</span></p>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(/frontend/vegefoods/images/about.jpg);">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Selamat Datang Di Website Kami</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>Kami menyediakan macam macam kue atau donat yang harganya murah tapi rasa tidak murahan dan bisa menggoyangkan lidah penikmat kue kami.</p>
      ...
      <div class="container py-4">
		...
		<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(/frontend/vegefoods/images/bg_3.jpg);">
    	<div class="container">
