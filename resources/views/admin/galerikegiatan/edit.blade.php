    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('galerikegiatan.update', $data->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
            <img src="{{asset('assets/img/galerikegiatan/' .$data->foto. '')}}"style="width:50px; height:50px;" alt="Foto">
